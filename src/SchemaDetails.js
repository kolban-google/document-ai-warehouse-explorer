  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", rowGap: 1 }}>
      {!props.create ?
        ...
        : null}
      <TextField value={props.documentSchema.displayName} onChange={onDisplayNameChange} label="displayName" variant="outlined" error={props.documentSchema.displayName.length === 0}/>
      {!props.create ?
        <TextField value={props.documentSchema.updateTime} label="updateTime" variant="outlined" disabled />
        : null}
      {!props.create ?
        <TextField value={props.documentSchema.createTime} label="createTime" variant="outlined" disabled />
        : null}
